...
export class CallDemand extends CallBase {
    ...
    async operate(txb, passport, account) {
        ...
        if (obj) {
            ...
            if (this.data?.time_expire !== undefined && object_address) {
                obj?.expand_time(this.data.time_expire.op === 'duration' ? true : false, this.data.time_expire.op === 'duration' ? this.data.time_expire.minutes : this.data.time_expire.time, passport);
            }
