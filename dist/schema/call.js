...
export const ObjectExistedSchema = (object = '') => {
...
const GetNamedObjectSchema = (object = '') => {
...
const ObjectParamSchema = (object = '') => {
    return z.union([
...
const ObjectsOperationSchema = (object = '') => {
    return z.union([
        z.object({
