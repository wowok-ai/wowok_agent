...
export declare const SupplierGuard_Description = "Supplier Orders Commitment and Guard verification: Verify the supplier orders and other conditions. This operation can only be completed if the Guard verification is successful.";
export declare const SupplierGuard_OrderIds_Description = "Supplier Orders Commitment. The order IDs in the Guard table that need to be verified for the the proposer. ";
...
export declare const Guard_Table_Des = "Identifier introduction or witness usage";
