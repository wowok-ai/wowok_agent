...
export declare const Permission_Builder_Description = "Modify the builder address (Builder is the sole highest owner of the Permission object; default: signer address of the Permission object creation transaction. Important note: Builder can only be changed by the Permission object's original builder. If the user does not explicitly specify this field, the AI should not attempt to set it. Failure of the operation may occur due to insufficient permissions.";
