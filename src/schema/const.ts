...
export const ObjectNewDescription = (object: string='') : string => {
    return `Creating a new on-chain ${object} object`
}

export const GetObjectDataDescription = (object: string='') : string => {
    if (object === 'Guard') {
...
export const ObjectParamSchema_Description = (object:string='') => {
...
export const GuardCalcStringLowercase_Description = `Convert the string returned by the first child node to lowercase, with the result serving as the return value of this node`;
...
export const TYPE_LOGIC_AS_U256_GREATER_Description = `The return value of the first child node is greater than the return values of other child nodes(${WOWOK.Guard.MAX_LOGIC_COUNT} nodes at most): True; otherwise, False`;
export const TYPE_LOGIC_AS_U256_GREATER_EQUAL_Description = `The return value of the first child node is greater than or equal to the return values of other child nodes(${WOWOK.Guard.MAX_LOGIC_COUNT} nodes at most): True; otherwise, False`;
export const TYPE_LOGIC_AS_U256_LESSER_Description = `The return value of the first child node is less than the return values of other child nodes(${WOWOK.Guard.MAX_LOGIC_COUNT} nodes at most): True; otherwise, False`;
export const TYPE_LOGIC_AS_U256_LESSER_EQUAL_Description = `The return value of the first child node is less than or equal to the return values of other child nodes(${WOWOK.Guard.MAX_LOGIC_COUNT} nodes at most): True; otherwise, False`;
export const TYPE_LOGIC_AS_U256_EQUAL_Description = `The return value of the first child node is numerically equal to the return values of other child nodes(${WOWOK.Guard.MAX_LOGIC_COUNT} nodes at most): True; otherwise, False`;
export const TYPE_LOGIC_EQUAL_Description = `The return value of the first child node is exactly equal to (including data type) the return values of other child nodes(${WOWOK.Guard.MAX_LOGIC_COUNT} nodes at most): True; otherwise, False`;
export const TYPE_LOGIC_HAS_SUBSTRING_Description = `The string returned by the first child node contains the string returned by other child nodes(${WOWOK.Guard.MAX_LOGIC_COUNT} nodes at most): True; otherwise, False`;
export const TYPE_LOGIC_NOT_Description = `Logically negate the return value of the first child node`;
export const TYPE_LOGIC_AND_Description = `Perform an AND operation on the return values of other child nodes(${WOWOK.Guard.MAX_LOGIC_COUNT} nodes at most), and serve as the return value of this node`;
export const TYPE_LOGIC_OR_Description = `Perform an OR operation on the return values of other child nodes(${WOWOK.Guard.MAX_LOGIC_COUNT} nodes at most), and serve as the return value of this node`;
export const SupplierGuard_Description = `Supplier Orders Commitment and Guard verification: Verify the supplier orders and other conditions. This operation can only be completed if the Guard verification is successful.`;
export const SupplierGuard_OrderIds_Description = `Supplier Orders Commitment. The order IDs in the Guard table that need to be verified for the the proposer. `;
...
export const GuardRate_Add_Description = `Add or set the list of Guard objects and their corresponding rate values (in basis points, e.g., 3000 basis points = 30%)`;
export const GuardRate_Description = `Manages a list of Guard objects and their corresponding rate values (in basis points, e.g., 3000 basis points = 30%)`;
...
export const Demand_Guard_Description = `Set or unset the Guard (the 'guard' field specifies a string or null). If the operation is successful, anyone recommending a service to the Demand must simultaneously pass the Guard verification. If the 'service_id_in_guard' field is set, the recommended service address must be provided as the witness corresponding to service_id_in_guard during Guard verification`;
export const Guard_Root_Description = `Root data node`;
export const Guard_Table_Des = `Identifier introduction or witness usage`;
...
export const Discount_Off = `Discount value. If Basis Point Coupon, expressed in basis points (e.g., 3000 basis points = 30%); If Flat-rate coupon, fixed amount deduction`;
...
export const Discount_Type = `Discount type. 
    ${WOWOK.Service_Discount_Type.ratio}:Basis Point Coupon (in basis points, e.g., 3000 basis points = 30%)
